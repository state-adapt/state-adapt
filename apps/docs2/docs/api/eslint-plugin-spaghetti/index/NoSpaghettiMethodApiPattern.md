...
Defined in: lib/no-spaghetti-options.ts:2
...
Defined in: lib/no-spaghetti-options.ts:15
...
Defined in: lib/no-spaghetti-options.ts:11
...
Defined in: lib/no-spaghetti-options.ts:6
...
Defined in: lib/no-spaghetti-options.ts:4
...
Defined in: lib/no-spaghetti-options.ts:9
...
Defined in: lib/no-spaghetti-options.ts:13
