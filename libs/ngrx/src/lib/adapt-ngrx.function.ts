...
//  - The phrase "`adaptNgrx` wraps {@link StateAdapt.adapt}, calling `inject(AdaptNgrx)` to get an instance of {@link StateAdapt} that uses NgRx for the global store."
...
/**
  ...
  4\. A source can be a function that takes in a detached store (result of calling {@link watchNgrx}) and returns any of the above
  types of sources.
